  ...
  return (
    <>
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-6 col-lg-3">
          <div className={`card border-0 h-100 ${styles.bgPrimaryOpacity}`}>
            <div className="card-body text-center py-4">
              <FileText size={32} className={`mb-3 ${styles.textPrimary}`} />
              <h4 className={`fw-bold mb-1 ${styles.textPrimary}`}>{incidencias.length}</h4>
              <small className={`opacity-75 fw-medium ${styles.textPrimary}`}>Total</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card border-0 shadow-sm">
        <div className="card-header bg-white border-0 py-4 d-flex justify-content-between align-items-center">
          <h6 className="mb-0 text-dark fw-semibold d-flex align-items-center">
            <FileText size={20} className={`me-2 ${styles.textPrimary}`} />
            Mis Incidencias
          </h6>
                ...
                <div key={incidencia.id} className="list-group-item border-bottom border-0 py-4 px-4">
                  <div className="d-flex justify-content-between align-items-start flex-wrap gap-3">
                    ...
                    <div className="d-flex gap-2">
                      <button
                        className={`btn btn-sm ${styles.btnOutlinePrimary} d-flex align-items-center`}
            ...
            <div className="modal-content border-0 shadow">
              ...
              <div className="modal-body pt-2">
                <div className="row g-4">
                  ...
                  {selectedIncidencia.archivo_evidencia && (
                    <div className="col-12">
                      <label className="form-label fw-semibold text-dark small mb-2">Archivo de Evidencia</label>
                      <div className="card border-0 bg-light">
                        <div className="card-body p-4">
                          <div className="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                <div className="fw-medium text-dark">{selectedIncidencia.archivo_evidencia}</div>
                                <small className="text-muted">Archivo adjunto</small>
                              </div>
                            </div>
                            {!isOffline && (
                              <button
                                className={`btn ${styles.btnPrimary} d-flex align-items-center`}
                                onClick={() =>
                                  handleDownloadFile(selectedIncidencia.archivo_url, selectedIncidencia.archivo_evidencia)
                                }
                              >
