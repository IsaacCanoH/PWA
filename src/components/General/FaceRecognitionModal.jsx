...
const FaceRecognitionModal = ({ show, onSuccess, onFailure, usuario, onClose, themeClass }) => {
    ...
    <div className="modal fade show d-block" tabIndex="-1" role="dialog" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
      <div className="modal-dialog modal-dialog-centered" role="document">
        <div className="modal-content">
          <div
            className={`modal-header text-white ${themeClass === "supervisorTheme" ? "bg-supervisor" : themeClass === "enlaceTheme" ? "bg-enlace" : "bg-primary"}`}
          >
          ...
          <div className="modal-body text-center">
            {loading && (
              <div
                className={`spinner-border mb-3 ${themeClass === "supervisorTheme" ? "text-supervisor" : themeClass === "enlaceTheme" ? "text-enlace" : "text-primary"}`}
                role="status"
              ></div>
            )}
